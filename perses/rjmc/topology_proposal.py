...
class TractableValenceProposalEngine(ProposalEngine):
    ...
    def _generate_system_dictionary(self):
        """
        This function generates a dictionary of tractable valence systems for use by the proposal engine.
        The dictionary consists of {chemical_state_key : system} pairs.

        Returns
        -------
        system_dictionary : dict
            Dictionary of {chemical_state_key : openmm.System} pairs
        """
